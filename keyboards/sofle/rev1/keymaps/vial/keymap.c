...
[2] = LAYOUT(
  ...
  _______,  KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______,                      LSFT(KC_QUOT), KC_UNDS, KC_QUOT, KC_INS,  KC_HOME, KC_PGUP,
...
[3] = LAYOUT(
  ...
  _______, KC_LEFT, KC_DOWN, KC_RGHT,  _______,  _______,                     LSFT(KC_QUOT), KC_UNDS, KC_QUOT, KC_NUHS, _______, _______,

 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TRNS | LEFT | DOWN | RGHT | TRNS | TRNS |-------.    ,-------| TRNS | TRNS | '/@ | INS  | HOME | PGUP |
 * |------+------+------+------+------+------| MUTE  |    | Play  |------+------+------+------+------+------|
...
[2] = LAYOUT(
  ...
  _______,  KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______,                            _______, _______, KC_QUOT, KC_INS,  KC_HOME, KC_PGUP,
...
[3] = LAYOUT(
  ...
  _______, KC_LEFT, KC_DOWN, KC_RGHT,  _______,  _______,                           _______, _______, KC_QUOT, KC_NUHS, _______, _______,
